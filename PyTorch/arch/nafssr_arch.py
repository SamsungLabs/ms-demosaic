...
from .nafnet_util import MySequential
...
class NAFNetSR(nn.Module):
    ...
    '''
    def __init__(self, up_scale=4, width=48, num_blks=16, in_channels=3, out_channels=16, drop_path_rate=0., drop_out_rate=0., fusion_from=-1, fusion_to=-1, dual=False):
        super().__init__()
        ...
        self.up = nn.Sequential(
            nn.Conv2d(in_channels=width, out_channels=out_channels * up_scale**2, kernel_size=3, padding=1, stride=1, groups=1, bias=True),
