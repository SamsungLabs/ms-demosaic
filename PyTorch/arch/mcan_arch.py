...
class MCANNet(nn.Module):
    def __init__(self, size):
        super(MCANNet, self).__init__()
        ...
        if size == "large":
            ...
            for i in range(22):
                self.convs.append(self.make_layer(_Conv_attention_Block))
    ...
    def forward(self, data, pos_mat):
        ...
        return  convt_br1_temp, torch.add(HR_4x, WB_norelu)
